...
export const Outro:React.FC=()=>{
 ...
 return <AbsoluteFill style={{background:'#101715',fontFamily:'"PingFang SC", "Heiti SC", sans-serif',color:C.paper,overflow:'hidden'}}>
  ...
  <div style={{position:'absolute',left:99,top:134,fontSize:72,fontWeight:700,letterSpacing:-2,opacity:appear,translate:`0 ${lerp(f,0,20,20,0)}px`}}>从 AI Coding，<span style={{color:C.lime}}>一步步做出项目。</span></div>
